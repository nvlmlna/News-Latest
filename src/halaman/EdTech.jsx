...
const EdTech = () => {
  return (
    <div className="text-3xl font-bold dark:text-white text-opacity-30 bg-gray-400 dark:bg-gray-800 min-h-screen">
      {posts && posts.length > 0 && (
      <h1 className="text-2xl font-bold text-center mt-12 mb-6 ">EdTech News Latest</h1>
      )}
